...
# !!! Main.UserApp is configured as an alias for Main.Ctltest and you might encounter it in some tests
using Main.Ctltest, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Ctltest tests" begin
  @includetests ARGS
end
